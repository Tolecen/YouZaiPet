...
@end
@interface PaiHangShuoShuoTableHelper : NSObject<UITableViewDataSource,UITableViewDelegate,XHAudioPlayerHelperDelegate,TalkingTableViewCellDelegate,DeleteShuoShuoDelegate,UIAlertViewDelegate,AttentionDelegate,ImagesLoadedDelegate,RefreshAnimationEnded,RefreshAnimationEndedFooter>{
...
@property (nonatomic,strong)NSMutableArray * yueduArray;
