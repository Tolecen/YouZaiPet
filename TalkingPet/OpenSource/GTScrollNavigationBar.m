...
- (void)resetToDefaultPositionWithAnimation:(BOOL)animated
{
    ...
    if ([self.thedelegate respondsToSelector:@selector(scrollUp:)]) {
        [self.thedelegate scrollUp:NO];
    }
...
//    if (self.needChangedInsets) {
//        NSLog(@"sssddddd:%f,theFrame:%@",_scrollView.contentOffset.y,NSStringFromCGRect(frame));
//        if (frame.origin.y<20) {
//            [_scrollView setContentInset:UIEdgeInsetsMake(64-(20-frame.origin.y), 0, 50, 0)];
//        }
//        else
//        {
//            [_scrollView setContentInset:UIEdgeInsetsMake(64, 0, 50, 0)];
//        }
//    }
