...
//                self.lastUpdateTime = [NSDate date];
                NSLog(@"121212");
                self.qiqiuImageV.hidden = NO;
                [self.dogImageV stopAnimating];
                self.qiqiuImageV.frame = CGRectMake(200, 0, 20, 20);
                self.qiqiuImageV.center = CGPointMake(125, 20);
                [self.dogImageV setImage:[UIImage imageNamed:@"refresh_08.png"]];
...
//                NSLog(@"343434");
                ...
                [self.dogImageV stopAnimating];
                [self.dogImageV setImage:[UIImage imageNamed:@"refresh_08.png"]];
                self.qiqiuImageV.frame = CGRectMake(200, 0, 45, 45);
                self.qiqiuImageV.center = CGPointMake(125, 20);
...
//                NSArray * canFreshArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"refresh_08.png"],[UIImage imageNamed:@"refresh_07.png"],[UIImage imageNamed:@"refresh_06.png"],[UIImage imageNamed:@"refresh_05.png"],[UIImage imageNamed:@"refresh_04.png"],[UIImage imageNamed:@"refresh_03.png"],[UIImage imageNamed:@"refresh_02.png"],[UIImage imageNamed:@"refresh_01.png"], nil];
//                self.dogImageV.animationImages = canFreshArray;
//                
//                self.dogImageV.animationRepeatCount = 1;
//                [self.dogImageV startAnimating];
//                [UIView animateWithDuration:self.dogImageV.animationDuration animations:^{
//                    
//                } completion:^(BOOL finished) {
//                    [self.dogImageV setImage:[UIImage imageNamed:@"refresh_01.png"]];
//                }];
                // 执行动画
...
//            NSArray * canFreshArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"refresh_01.png"],[UIImage imageNamed:@"refresh_02.png"],[UIImage imageNamed:@"refresh_03.png"],[UIImage imageNamed:@"refresh_04.png"],[UIImage imageNamed:@"refresh_05.png"],[UIImage imageNamed:@"refresh_06.png"],[UIImage imageNamed:@"refresh_07.png"],[UIImage imageNamed:@"refresh_08.png"], nil];
//            self.dogImageV.animationImages = canFreshArray;
//            
//            self.dogImageV.animationRepeatCount = 1;
//            [self.dogImageV startAnimating];
...
//            self.statusLabel.text = MJRefreshHeaderRefreshing;
            self.qiqiuImageV.hidden = YES;
            NSArray * canFreshArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"refresh_09.png"],[UIImage imageNamed:@"refresh_10.png"],[UIImage imageNamed:@"refresh_11.png"],[UIImage imageNamed:@"refresh_12.png"],nil];
            self.dogImageV.animationImages = canFreshArray;
            self.dogImageV.animationDuration = 0.8;
            self.dogImageV.animationRepeatCount = 0;
            [self.dogImageV startAnimating];
            // 执行动画
            [UIView animateWithDuration:MJRefreshFastAnimationDuration animations:^{
                // 1.增加滚动区域
