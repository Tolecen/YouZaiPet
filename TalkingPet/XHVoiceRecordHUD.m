...
- (void)resaueRecord {
    ...
    self.remindLabel.backgroundColor = [UIColor clearColor];
    [self.remindLabel setTextColor:[UIColor orangeColor]];
...
- (void)setup {
    ...
    if (!_remindLabel) {
        UILabel *remindLabel= [[UILabel alloc] initWithFrame:CGRectMake(9.0, 110.0, 120.0, 21.0)];
    ...
    if (!_recordingHUDImageView) {
        UIImageView *recordHUDImageView = [[UIImageView alloc] initWithFrame:CGRectMake(88.0, 34.0, 18.0, 61.0)];
