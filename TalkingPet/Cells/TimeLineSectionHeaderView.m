...
//        [self.contentView addSubview:sl];
        ...
        if (showHead) {
            self.publisherAvatarV = [[EGOImageButton alloc] initWithFrame:CGRectMake(10, 5, 50, 50)];
...
//        self.timeBgImg = image;
        ...
        self.timeL = [[UILabel alloc] initWithFrame:CGRectMake(14, 0, 100, 20)];
        [self.timeL setBackgroundColor:[UIColor clearColor]];
        [self.timeL setTextColor:[UIColor whiteColor]];
        ...
        [self.timeBgV addSubview:self.timeL];
...
//    self.tintColor = [UIColor clearColor];
    if (self.showTheHead) {
        ...
        else
        {
            ...
            [self.publisherNameL setFrame:CGRectMake(65,self.publisherAvatarV.frame.origin.y+3, 160, 20)];
        }
